    ...
    return (
      <div className="space-y-3">
        ...
        <p className="max-w-prose text-body text-ink-muted">
          ...
          Endocrinología, configura tu especialidad como Endocrinología en
          tu perfil, o sube a Clínica para acceso a todos los departamentos.
        </p>
