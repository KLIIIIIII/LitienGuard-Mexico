...
> = {
  free: [
    ...
    { label: "Cerebro clínico en modo lectura", ok: true },
    { label: "Export PDF firmable", ok: false },
    { label: "Recetas electrónicas", ok: false },
    { label: "Agenda de citas", ok: false },
    { label: "Portal del paciente", ok: false },
  ],
  esencial: [
    { label: "100 notas SOAP al mes", ok: true },
    { label: "Cerebro clínico completo", ok: true },
    { label: "Odontograma + export PDF", ok: true },
    { label: "Export PDF de SOAP firmable", ok: true },
    { label: "MFA opcional y audit log", ok: true },
    { label: "Soporte por correo (48 h)", ok: true },
  ],
  profesional: [
    { label: "300 notas SOAP al mes", ok: true },
    { label: "Cerebro académico + práctica colectiva", ok: true },
    { label: "Recetas electrónicas NOM-024", ok: true },
    { label: "Agenda + reservación pública gratis", ok: true },
    { label: "Recordatorios automáticos al paciente", ok: true },
    { label: "Portal del paciente integrado", ok: true },
    { label: "Soporte por correo (24 h)", ok: true },
  ],
  clinica: [
    { label: "Notas y citas ilimitadas", ok: true },
    { label: "Multi-usuario con roles personalizados", ok: true },
    { label: "RCM Copilot (Q1 2027)", ok: true },
    ...
    { label: "White-label opcional", ok: true },
  ],
};
